                    ...
                    <table id="mytable" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Tanggal Berakhir Posting</th>
                    ...
                    <div class="box-body">
                      <form role="form">
                        <div class="form-group has-error">
                          ...
                          <input type="text" class="form-control input-sm" id="name" name="name" placeholder="Enter ...">
                          <span class="help-block">Help block with error</span>
                        </div>
                        <div class="form-group has-error">
                          <label class="control-label">Url</label>
                          <input type="text" class="form-control input-sm" id="url" name="url" placeholder="Enter ...">
                          <span class="help-block">Help block with error</span>
                        </div>
                        <div class="form-group has-error">
                          <label class="control-label"></i>Title</label>
                          <input type="text" class="form-control input-sm" id="title" name="title" placeholder="Enter ...">
                          <span class="help-block">Help block with error</span>
                        </div>
                        <div class="form-group has-error">
                          <label class="control-label"></i>Title</label>
                        ...
                        <div class="form-group has-error">
                          ...
                          <div class="checkbox">
                              <label>
                                  <div class="radio">
                                      <label>
                                          <input type="radio" name="enable" id="enable0" value="0" checked="checked">
                                            Nonaktifkan
                                      </label>
                                      <label>
                                          <input type="radio" name="enable" id="enable1" value="1">
                                            Aktifkan
                                      </label>
                                  </div>
                              </label>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/aplikasi/js/slideshow.js"> </script>
