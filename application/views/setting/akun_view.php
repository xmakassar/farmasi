                    ...
                    <div class="box-body">
                      <form role="form">
                        ...
                        <div class="form-group has-error">
                          ...
                          <input type="text" class="form-control input-sm" id="username" name="username" placeholder="Enter ...">
                          <span class="help-block">Help block with error</span>
                        </div>
                        <div class="form-group has-error">
                          <label class="control-label">Nama Lengkap</label>
                          <input type="text" class="form-control input-sm" id="nama_lengkap" name="nama_lengkap" placeholder="Enter ...">
                        </div>
                        <div class="form-group has-error">
                          <label class="control-label"></i>Alamat</label>
                          <input type="text" class="form-control input-sm" id="alamat" name="alamat" placeholder="Enter ...">
                          <span class="help-block">Help block with error</span>
                        </div>
                        <div class="form-group has-error">
                          <label class="control-label"></i>Password</label>
                          <input type="password" class="form-control input-sm" id="password" name="password" placeholder="Enter ...">
                          <span class="help-block">Help block with error</span>
                        </div>
                        <div class="form-group has-error">
                        ...
                        <div class="form-group has-error">
                          <label class="control-label"></i>Blokir</label>
                          <div class="checkbox">
                              <label>
                                  <div class="radio">
                                      <label>
                                          <input type="radio" name="blokir" id="enable0" value="0" checked="checked">
                                            Nonaktifkan
                                      </label>
                                      <label>
                                          <input type="radio" name="blokir" id="enable1" value="1">
                                            Aktifkan
                                      </label>
                                  </div>
                              </label>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/aplikasi/js/akun.js"> </script>
