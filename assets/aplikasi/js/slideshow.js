$(document).ready(function(){
   //datatables
    table = $('#mytable').DataTable({
        ...
        "ajax": {
            "url": base_url+"slideshow/ajax_list",
            "type": "POST",
...
function save() {
    ...
    if (save_method==='add') {
        ...
        url = base_url+"slideshow/ajax_update";
...
function hapus(id) {
    bootbox.confirm("Are you sure?", function(result) {
        if(result) {
            $.ajax({
                url : base_url+"slideshow/ajax_delete/"+id,
                type: "POST",
                data: $('#form').serialize(),
                dataType: "JSON",
                success: function(data)
...
function update(id)
{
    ...
    $.ajax({
        url : base_url+"slideshow/ajax_edit/"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            $('[name="id_pk"]').val(data.slideshows_id);
